...
final class Version20250726044321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotions (id INT AUTO_INCREMENT NOT NULL, promotion_type ENUM(\'sku\' , \'category\' ) NOT NULL, applicable_to VARCHAR(255) NOT NULL, percentage INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX idx_applicable_to (applicable_to), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
